    ...
    <div className="max-w-4xl mx-auto pt-4 px-4 md:px-0">
      <div className="flex justify-between">
        <div className="relative">
          <h4 className="text-xl font-bold">Tüm Parçalar</h4>
          ...
          if (index < 10) {
            return (
              <Link key={index} href={`/parca/${product._id}`}>
                <div
                  key={index}
                  className="rounded-xl h-80 border shadow-md py-[10px] px-4"
                >
                  ...
                  <div className="h-[120px] flex flex-col gap-1">
                    ...
                    <span className="h-[75px] overflow-hidden text-base font-semibold">
                      {product.name}
                    </span>
